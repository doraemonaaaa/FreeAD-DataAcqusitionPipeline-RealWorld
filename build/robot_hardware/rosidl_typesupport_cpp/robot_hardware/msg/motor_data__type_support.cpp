...
static const _MotorData_type_support_symbol_names_t _MotorData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_hardware, msg, MotorData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_hardware, msg, MotorData)),
  }
};
...
{
  return &::robot_hardware::msg::rosidl_typesupport_cpp::MotorData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_hardware, msg, MotorData)() {
  return get_message_type_support_handle<robot_hardware::msg::MotorData>();
}
