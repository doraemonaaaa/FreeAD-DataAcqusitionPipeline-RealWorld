...
bool robot_hardware__msg__motor_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_hardware.msg._motor_data.MotorData", full_classname_dest, 40) == 0);
  }
  robot_hardware__msg__MotorData * ros_message = _ros_message;
  {  // real_left_speed_rpm
...
PyObject * robot_hardware__msg__motor_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_hardware.msg._motor_data");
