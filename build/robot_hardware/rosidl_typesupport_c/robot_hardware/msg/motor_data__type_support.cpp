...
static const _MotorData_type_support_symbol_names_t _MotorData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_hardware, msg, MotorData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_hardware, msg, MotorData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_hardware, msg, MotorData)() {
  return &::robot_hardware::msg::rosidl_typesupport_c::MotorData_message_type_support_handle;
}
