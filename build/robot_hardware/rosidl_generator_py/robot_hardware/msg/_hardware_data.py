...
class HardwareData(metaclass=Metaclass_HardwareData):
    ...
    _fields_and_field_types = {
        'real_left_speed': 'int16',
        'real_right_speed': 'int16',
        'real_left_neg_flag': 'uint8',
        'real_right_neg_flag': 'uint8',
        'expect_left_speed': 'int16',
        'expect_right_speed': 'int16',
    ...
    def __init__(self, **kwargs):
        ...
        self.real_left_speed = kwargs.get('real_left_speed', int())
        self.real_right_speed = kwargs.get('real_right_speed', int())
        self.real_left_neg_flag = kwargs.get('real_left_neg_flag', int())
        self.real_right_neg_flag = kwargs.get('real_right_neg_flag', int())
        self.expect_left_speed = kwargs.get('expect_left_speed', int())
        self.expect_right_speed = kwargs.get('expect_right_speed', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.real_left_speed != other.real_left_speed:
            return False
        if self.real_right_speed != other.real_right_speed:
            return False
        if self.real_left_neg_flag != other.real_left_neg_flag:
            return False
        if self.real_right_neg_flag != other.real_right_neg_flag:
            return False
        if self.expect_left_speed != other.expect_left_speed:
            return False
        if self.expect_right_speed != other.expect_right_speed:
            return False
    ...
    @builtins.property
    def real_left_speed(self):
        """Message field 'real_left_speed'."""
        return self._real_left_speed

    @real_left_speed.setter
    def real_left_speed(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'real_left_speed' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'real_left_speed' field must be an integer in [-32768, 32767]"
        self._real_left_speed = value

    @builtins.property
    def real_right_speed(self):
        """Message field 'real_right_speed'."""
        return self._real_right_speed

    @real_right_speed.setter
    def real_right_speed(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'real_right_speed' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'real_right_speed' field must be an integer in [-32768, 32767]"
        self._real_right_speed = value
    ...
    @builtins.property
    def expect_left_speed(self):
        """Message field 'expect_left_speed'."""
        return self._expect_left_speed

    @expect_left_speed.setter
    def expect_left_speed(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'expect_left_speed' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'expect_left_speed' field must be an integer in [-32768, 32767]"
        self._expect_left_speed = value

    @builtins.property
    def expect_right_speed(self):
        """Message field 'expect_right_speed'."""
        return self._expect_right_speed

    @expect_right_speed.setter
    def expect_right_speed(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'expect_right_speed' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'expect_right_speed' field must be an integer in [-32768, 32767]"
        self._expect_right_speed = value
