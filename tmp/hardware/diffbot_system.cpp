...
namespace diff_control
{
        ...
        const rclcpp_lifecycle::State & /*previous_state*/)
    {
        ...
        // serial_bridge_.connect(cfg_.device, cfg_.baud_rate, cfg_.timeout_ms);
        ...
        const rclcpp_lifecycle::State & /*previous_state*/)
    {
        ...
        // serial_bridge_->set_pid_values(30, 20, 0, 100);
    ...
    {
        serial_bridge_->read_encoder_values(wheel_l_.enc, wheel_r_.enc);
        ...
        //   RCLCPP_INFO(
        //     rclcpp::get_logger("DiffBotSystemHardware"),
        //     "Got position state %.5f and velocity state %.5f for '%speriod'!", hw_positions_[i],
        ...
        const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
    {
        ...
        serial_bridge_->set_motor_values((int)motor_l_counts_per_loop, (int)motor_r_counts_per_loop);
